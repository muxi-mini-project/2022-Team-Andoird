...
public class InCompleteFragment extends Fragment {
    ...
    private InCompleteFragment.TaskAdapter mTaskAdapter;
    @Nullable
    @Override
    ...
    private void UpdateUI(){
        ...
        if(mTaskAdapter==null){
            mTaskAdapter=new InCompleteFragment.TaskAdapter(taskData);
            //很重要
    ...
    private class TaskAdapter extends RecyclerView.Adapter{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            return new InCompleteFragment.TaskHolder(layoutInflater,parent);
        }

        @Override
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            if(holder instanceof InCompleteFragment.TaskHolder){
                TaskData taskData=mTaskData.get(position);
                ((InCompleteFragment.TaskHolder)holder).bind(taskData);
            }
        }
